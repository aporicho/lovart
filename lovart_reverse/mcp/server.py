...
TOOLS: list[dict[str, Any]] = [
    ...
    _tool("lovart_jobs_quote_status", "Read local batch quote progress.", {"run_dir": _string_schema()}, ["run_dir"]),
    _tool(
        "lovart_jobs_dry_run",
...
def call_tool_data(name: str, arguments: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    handlers: dict[str, Callable[[], dict[str, Any]]] = {
        ...
        "lovart_jobs_quote_status": lambda: jobs_quote_status_command(Path(str(args["run_dir"]))),
